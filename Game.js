...
function nextLevel() {
    alert("Play with an opponent. Each of you will play the game for 3 rounds and add up your end of round scores. Whoever has the highest cumulative score wins!");
  }